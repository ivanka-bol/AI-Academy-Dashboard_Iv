-- Create admin user for lubor.fedak@kyndryl.com
...
BEGIN
  ...
  SELECT id INTO new_user_id FROM auth.users WHERE email = 'lubor.fedak@kyndryl.com';
  ...
  VALUES (new_user_id, 'lubor.fedak@kyndryl.com', 'Lubor Fedak', true)
...
WHERE au.email = 'lubor.fedak@kyndryl.com';
